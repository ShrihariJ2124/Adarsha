    ...
    <section id="management" className="py-16 lg:py-24 bg-white/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[320px_1fr] gap-8 lg:gap-10 items-start">
          ...
          >
            <p>
              It gives me immense happiness to witness the continued growth and progress of ADARSH Higher Primary
            ...
            <p>
              ADARSH HPS BELAKAVADI plays a vital role in providing quality education to children from rural and
