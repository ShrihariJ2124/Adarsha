...
export const siteImages = {
  ...
  facilities: {
    ...
    computers: imagePath('download.jpg'),
    playground: imagePath('hero-03-playground.jpg'),
    drinkingWater: imagePath('drinkingwater.jpg'),
    electricity: imagePath('electricity.jpg'),
    toilets: imagePath('girlsandboystoilets.png'),
